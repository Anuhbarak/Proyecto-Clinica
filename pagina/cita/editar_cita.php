...
?>
 ...
 <!--end of modal-->
                  ...
                  <h3 class="box-title" style= "font-size: 25px"><B>MODIFICAR CITA</B></h3>
                </div><!-- /.box-header -->
              
              <a class="btn btn-warning btn-print" href="cita.php"    style="height:25%; width:15%; font-size: 16px " role="button">REGRESAR</a>
...
?>
            ...
            <input type="hidden" class="form-control" id="id_cita" name="id_cita" value="<?php echo $id_cita;?>" required>
                    ...
                    <div class="col-md-3 btn-print">
                      <div class="form-group">
                        <label for="date" ><p>MEDICO</p></label>
     ...
     <div class="row">
                    <div class="col-md-3 btn-print">
                      <div class="form-group">
                        <label for="date" ><p>OBSERVACIONES</p></label>
                   ...
                   <textarea  class="form-control" style= "font-size: 18px" id="observaciones" name="observaciones"><?php echo $row['observaciones'];?></textarea>
               ...
               <div class="row">
                    <div class="col-md-3 btn-print">
                      <div class="form-group">
                        <label for="date" ><p>FECHA </p></label>
            ...
            <input type="date" class="form-control" style= "font-size: 20px" id="fecha"  name="fecha"  value="<?php echo $row['fecha'];?>" >
                      </div>
                    </div>
                           <div class="col-md-4 btn-print">

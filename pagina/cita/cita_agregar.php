     ...
     <h3><?php //echo "<h2> $nombre</h2>"; ?></h3>
            ...
            <div class="col-md-8">
              ...
              <div class="box box-info">
                <div class="box-header with-border">
                  <h3 class="box-title" style= "font-size: 25px"><B>REGISTRAR  NUEVA CITA</B></h3>
                </div><!-- /.box-header -->
                <!-- form start -->
...
<div id="suggestions"></div>
    ...
    <form  class="form-inline" name="f1" action="./cita_add.php" method="POST">
      ...
      <DIV><p><B>PACIENTE</B></p>
    <div class="input-group input-group-sm">
  <input class="search_query form-control" style= "font-size: 19px" type="text" name="key" id="key" placeholder="Buscar..." required>
...
<BR>
          ...
          <div class="row">
             <div class="col-md-3 btn-print">
                 <div class="form-group">
                     <label for="date" ><p>OBSERVACIONES</label>
           ...
           <div class="col-md-4 btn-print">
               <div class="form-group">
                    <textarea class="form-control" style= "font-size: 20px" id="observaciones" name="observaciones"></textarea>
               </div>
            </div>
            <div class="col-md-4 btn-print">
...
<BR>        
                    ...
                    <div class="col-md-3 btn-print">
                      <div class="form-group">
                        <label for="date" ><p>FECHA ASIGNADA</label>
      ...
      <input type="date" class="form-control pull-right" style= "font-size: 19px" id="fecha" name="fecha"  required>
      ...
      <div class="row">
                    <div class="col-md-3 btn-print">
                      <div class="form-group">
                        <label for="date" ><p>HORARIO</label>
                 
                      </div><!-- /.form group -->
                    </div>
                       <div class="col-md-4 btn-print">
                      <div class="form-group">
             <select class="form-control select2" style= "font-size: 19px" name="horario" required>
     ...
     <input name="paciente" style= "font-size: 19px" id="paciente" type="hidden"  required>

<br>
      <button type="submit" style= "font-size: 19px" class="btn btn-success">REGISTRAR CITA</button>
      
                    <a type="button" href="../layout/inicio.php" style= "font-size: 19px" class="btn btn-danger">SALIR </a>
                      </form>

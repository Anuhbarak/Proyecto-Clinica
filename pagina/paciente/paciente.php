...
.box-header {
 ...
 <!--end of modal-->
                ...
                <a class="btn btn-warning btn-print" href="paciente_agregar.php"    style="height:25%; width:15%; font-size: 21px " role="button">REGISTRAR</a>
...
<td ><P><?php echo $i;?></P></td>
 <td><P><IMG src="../usuario/subir_us/<?php echo $row['imagen'];?>" style="height:80PX" /></P></td>
  <td><P><?php echo $row['nombre'].'  '.$row['apellido'];?></P></td>
<td><P><?php echo $row['CURP'];?></P></td>
<td><P><?php echo $row['usuario'];?></P></td>
    ...
    <td><P><?php echo $row['correo'];?></P></td>                                      
                      ...
                      ?>
                      <a class="btn btn-danger btn-print" href="<?php  echo "editar_paciente.php?cid=$cid";?>" style=" font-size: 21px"  role="button">Editar</a>
 <a class="btn btn-success btn-print" href="<?php  echo "historial_paciente.php?cid=$cid";?>" style=" font-size: 21px" role="button">Historia</a>

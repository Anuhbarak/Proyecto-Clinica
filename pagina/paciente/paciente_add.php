...
//encriptando contraseña
	$pass=md5($password);
		...
		///finzalizo encriptacion
			...
			mysqli_query($con,"INSERT INTO usuario(usuario,password,imagen,tipo,nombre,apellido,telefono,correo,CURP)
				VALUES('$usuario','$pass','$img','$tipo','$nombre','$apellido','$telefono','$correo','$CURP')")or die(mysqli_error($con));
